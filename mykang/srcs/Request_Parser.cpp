...
void Request_Parser::run_parsing(std::string origin_message) {
...
void Request_Parser::parse_start_line(std::string message) {
...
// crlf
// 
void Request_Parser::parse_header(std::string message) {
...
void Request_Parser::parse_entity(std::string message) {
  entity_str = message;
}
...
** getter 에 해당되는 기능
*/
std::map<std::string, std::string> Request_Parser::get_start_line_map() {
  return (start_line_map);
}
std::map<std::string, std::vector<std::string> > Request_Parser::get_header_map() {
  return (header_map);
}
std::string Request_Parser::get_entity_str() {
  return (entity_str);
}
